...
public class HtmlUtil {
     ...
     * @return
     */
    public static String getTextWrap(String html) {
        if (html == null){
            return null;
        }
    ...
    public static void main(String[] args) {
        try {
            ...
            InputStreamReader isr = new InputStreamReader(new FileInputStream("C:\\Users\\Admin\\Desktop\\test.html"), "GBK");
